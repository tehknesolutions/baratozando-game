...
const tests = [
  ...
  'CellarLayerModel.test.js',
  'CellarReadabilityDirector.test.js',
  'CellarParallaxDirector.test.js',
  'CellarForegroundDirector.test.js',
  'CellarCameraDirector.test.js',
  'CellarSetDressingContract.test.js',
  'PlayableV3Gate.test.js',
];
...
console.log('Pure gameplay + Playable V3 presentation tests: PASS');
