...
import { PLAYER_ASSET_PATHS, PREMIUM_PLAYER_ASSET_PATHS } from '../../assets/assetKeys.js';
...
export class BootScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    for (const [key, path] of Object.entries(PREMIUM_PLAYER_ASSET_PATHS)) this.load.image(key, path);
